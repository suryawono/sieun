<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/blocked-student");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("CEKAL KTM") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td><?= $item['BlockedStudent']['npm'] ?></td>
                                    <td><?= $item['BlockedStudent']['name'] ?></td>
                                    <td><?= $item['BlockedStudent']['keterangan'] ?></td>
