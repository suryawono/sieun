<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/laporan_per_mahasiswa");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr">Laporan Per Mahasiswa
                <div class="pull-right">
                    <button class="btn btn-xs btn-default" type="button" onclick="exp('print', '<?php echo Router::url("per_mahasiswa/print?" . $_SERVER['QUERY_STRING'], true) ?>')">
