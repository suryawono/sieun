<?php echo $this->Form->create("Exam", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Jadwal Ujian") ?>
                    </h6>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("Exam.start_time", array("type" => "text", "div" => array("class" => "col-md-8"), "label" => false, "class" => "form-control timepicker"));
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("Exam.end_time", array("div" => array("class" => "col-md-8"), "type" => "text", "label" => false, "class" => "form-control timepicker"));
                                            ?>
                                        </div>
                                    </div>
                                </div>
