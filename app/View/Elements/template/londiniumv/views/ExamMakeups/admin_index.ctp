...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("PERMOHONAN UJIAN SUSULAN") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td><?= $this->Html->changeStatusSelect($item["ExamMakeup"]["id"], $examMakeupStatuses, $item["ExamMakeup"]["exam_makeup_status_id"], Router::url("/admin/exam_makeups/change_status/", true), "#approvalstatus{$i}"); ?></td>
